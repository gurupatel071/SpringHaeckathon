...
<title>Edit User Type | CodeVerse</title>
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <div class="page-container">
          ...
          <h3 class="page-title">Edit User Type</h3>
          <p class="page-subtitle">Update user role and classification details</p>
          ...
          <div class="form-card">
            ...
            <div class="form-card-header">
              ...
              <div class="form-card-header-text">
                ...
                <p>Modify the user type/role name</p>
              </div>
            </div>
            ...
            <div class="form-body">
              <form action="updateUserType" method="post">
                ...
                <div class="form-group">
                  <label>User Type Name <span style="color: var(--rose);">*</span></label>
                  <input type="text" name="userType" class="cv-input" value="${userType.userType}" placeholder="e.g., Student, Professional, Mentor" required>
                  <div class="field-hint">This label will appear when assigning roles to users</div>
                </div>

                <div class="button-group">
                  <button type="submit" class="btn-primary">💾 Update User Type</button>
                  <a href="listUserType" class="btn-secondary">← Cancel</a>
                </div>
              </form>
            </div>
