    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <div class="page-container">
          ...
          <h3 class="page-title">Edit Hackathon Description</h3>
          <p class="page-subtitle">Update the detailed description for your hackathon event</p>
          ...
          <div class="form-card">
            ...
            <div class="form-card-header">
              ...
              <div class="form-card-header-text">
                ...
                <p>Modify the HTML content for your hackathon description</p>
              </div>
            </div>

            <!-- Form Body -->
            <div class="form-body">
              <form action="/admin/hackathon/description/update" method="post">
                ...
                <div class="form-group">
                  ...
                  <textarea name="hackathonDetails" class="cv-textarea" rows="12" required>${description.hackathonDetails}</textarea>
                  <div class="field-hint">You can use HTML tags to format the description (e.g., &lt;strong&gt;, &lt;ul&gt;, &lt;li&gt;, etc.)</div>
                </div>

                <div class="button-group">
                  <button type="submit" class="btn-primary">💾 Update Description</button>
                  <a href="listHackathonDescription?hackathonId=${description.hackathonId}" class="btn-secondary">← Cancel</a>
                </div>
              </form>
            </div>
