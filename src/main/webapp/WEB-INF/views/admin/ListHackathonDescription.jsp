...
<body>
	...
	<div class="page-container">
		...
		<h3 class="page-title">Hackathon Descriptions</h3>
		<p class="page-subtitle">Manage detailed descriptions for each
			hackathon event</p>

		<div class="section-label">Description Library</div>
			...
			<div class="form-card-header">
				<div class="form-card-header-left">
					...
					<div class="form-card-header-text">
						<h5>All Descriptions</h5>
						<p>Browse, edit, or delete hackathon descriptions</p>
					</div>
				</div>
				<c:url var="newDescriptionUrl"
					value="/admin/hackathon/description/new">
					<c:if test="${hackathonId != null}">
						<c:param name="hackathonId" value="${hackathonId}" />
					</c:if>
				</c:url>
				<a href="${newDescriptionUrl}" class="btn-new"> + New
					Description </a>
			</div>
				...
				<table class="cv-table">
					...
					<tbody>
							...
							<tr>
								<td colspan="4">
									<div class="empty-state">
										...
										<h4>No Descriptions Found</h4>
										<p>You haven't added any descriptions for this hackathon
											yet.</p>
										<c:url var="newEmptyUrl"
											value="/admin/hackathon/description/new">
											<c:if test="${hackathonId != null}">
												<c:param name="hackathonId" value="${hackathonId}" />
											</c:if>
						...
						<c:forEach var="d" items="${descriptionList}" varStatus="i">
							<tr>
								<td>${i.index + 1}</td>
								<td><span class="hackathon-id">${d.hackathonId}</span></td>
								<td class="details-cell">${d.hackathonDetails}</td>
								<td>
									<div class="action-buttons">
										<a
											href="/admin/hackathon/description/edit?hackathonDescriptionId=${d.hackathonDescriptionId}"
											class="btn-action btn-edit">✏ Edit</a> <a
											href="/admin/hackathon/description/delete?hackathonDescriptionId=${d.hackathonDescriptionId}&hackathonId=${d.hackathonId}"
