		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<p class="page-subtitle">Add a new hackathon category to the
						platform</p>
							...
							<div class="form-card">
								...
								<div class="form-card-header">
									<div class="form-card-header-left">
										...
										<div class="form-card-header-text">
											...
											<p>This will appear as a filter option on hackathons</p>
										</div>
									</div>
									<a href="listCategory" class="view-all-link">View All →</a>
								</div>
								...
								<div class="form-card-body">
									<form action="saveCategory" method="post">
										...
										<div class="form-group-custom">
											<label class="form-label-custom"> Category Name <span
												class="req">*</span>
											</label>
											<div class="input-wrap">
												<span class="input-icon">📂</span> <input type="text"
													name="categoryName" class="form-control-custom"
													placeholder="e.g. Web Development, AI/ML, Cybersecurity"
													required>
											</div>
											<div class="field-hint">This label will be used to
												categorise hackathon events.</div>
										</div>
								...
								<div class="form-footer">
									...
									<button type="submit"
										...
										class="btn-submit">✓ Save Category</button>
								</div>
